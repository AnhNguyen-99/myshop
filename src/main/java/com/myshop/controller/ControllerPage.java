...
public class ControllerPage {
    ...
    // List danh sÃ¡ch sáº£n pháº©m theo producerId
...
//    }
    // Chọn sản phẩm
//    @RequestMapping(value = "/initAdd/{productId}", method = RequestMethod.GET)
//    public String viewInitAdd(@PathVariable("productId")Integer productId, Model model){
//       List<ProductSize> list = productSizeService.getListByProductId(productId);
//        Product product = productService.findById(productId);
//        model.addAttribute("product", product);
//        model.addAttribute("listProductSize", list);
//        return "page/chooseSize";
//    }
//    
    // Checkout
