...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Danh sách size</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
											...
											<c:forEach items="${listSize}" var="item">
												<tr>
													...
													<td><a class='btn btn-default'
														href='${pageContext.request.contextPath}/manages/size/edit/${item.sizeId}'><i
															class='fa fa-edit'></i></a>
														<p class='btn btn-default'
															onclick='checkdel(${item.sizeId})'>
	...
	<script>
        function checkdel(sizeId) {
            var sizeId = sizeId;
            var link = "${pageContext.request.contextPath}/manages/category/delete/" + sizeId;
