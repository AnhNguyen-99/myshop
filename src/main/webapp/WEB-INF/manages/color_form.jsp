				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Tạo màu mới</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<!-- Form tạo danh mục -->
										<form:form action="${pageContext.request.contextPath}/manages/color/save" method="POST" modelAttribute="color">
											<div class="form-group">
												<label>Tên màu</label>
												 <form:input class="form-control" type="text" path="colorName"/>
											</div>
											<div class="form-group">
