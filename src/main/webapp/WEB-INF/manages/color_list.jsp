...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Danh sách màu</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
											...
											<c:forEach items="${listColor}" var="item">
												<tr>
													...
													<td><a class='btn btn-default'
														href='${pageContext.request.contextPath}/manages/color/edit/${item.colorId}'><i
															class='fa fa-edit'></i></a>
														<p class='btn btn-default'
															onclick='checkdel(${item.colorId})'>
	...
	<script>
        function checkdel(colorId) {
            var colorId = colorId;
            var link = "${pageContext.request.contextPath}/manages/category/delete/" + colorId;
