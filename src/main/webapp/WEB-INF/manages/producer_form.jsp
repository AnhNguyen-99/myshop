				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Tạo NSX mới</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<form:form action="${pageContext.request.contextPath}/manages/producer/save" method="POST" modelAttribute="producer">
