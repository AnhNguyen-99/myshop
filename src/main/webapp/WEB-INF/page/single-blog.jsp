                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="${pageContext.request.contextPath}/resources/page/img/news/${news.img}" alt="" height="821px" width="1110px">
                                </div>
                            </div>
                            <div class="col-lg-3  col-md-3">
                                <div class="blog_info text-right">
                                    ...
                                    <ul class="blog_meta list">
                                        ...
                                        <li><a href="#">${news.createDate}<i class="lnr lnr-calendar-full"></i></a></li>
