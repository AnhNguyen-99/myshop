	...
	<div class="container">
		<div class="row">
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<ul class="infomation">
					<li style="background-color: rgb(255, 140, 0);"><a
						href="${pageContext.request.contextPath}/inforaccount">Thông
							tin</a></li>
					<li><a href="${pageContext.request.contextPath}/listOrders">Lịch
							sử mua hàng</a></li>
					<li><a href="${pageContext.request.contextPath}/changeInfor">Thay
							đổi thông tin</a></li>
					<li><a href="${pageContext.request.contextPath}/updatePass">Thay
							đổi mật khẩu</a></li>
				</ul>
			</div>
			<div class="col-1"></div>
				...
				<table class="table mt-15">
					...
					<c:forEach items="${listOrder}" var="item">
						<tr>
							...
							<td style="text-align: center;"><a href="${pageContext.request.contextPath}/detailOrder/${item.orderId}">View</a></td>
						</tr>
					</c:forEach>
				</table>
			</div>
