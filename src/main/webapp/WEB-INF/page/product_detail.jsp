...
<html>
<head>
	<title>${product.producerName}</title>
	<meta charset="utf-8">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread">
							<span><a href="index.html">Home</a></span> / <span>ProductDetails</span>
						</p>
					</div>
				</div>
			</div>
				...
				<div class="row row-pb-lg product-detail-wrap">
						...
						<div class="owl-carousel">
							<div class="item">
								<div class="product-entry border">
									<a href="#" class="prod-img"> <img src="${pageContext.request.contextPath}/resources/page/images/product/${product.productImage}"
							...
							<div class="item">
								<div class="product-entry border">
									<a href="#" class="prod-img"> <img src="${pageContext.request.contextPath}/resources/page/images/item-2.jpg"
										class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
								</div>
							</div>
							<div class="item">
								<div class="product-entry border">
									<a href="#" class="prod-img"> <img src="${pageContext.request.contextPath}/resources/page/images/item-3.jpg"
										class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
								</div>
							</div>
							<div class="item">
								<div class="product-entry border">
									<a href="#" class="prod-img"> <img src="${pageContext.request.contextPath}/resources/page/images/item-4.jpg"
										class="img-fluid" alt="Free html5 bootstrap 4 template">
									</a>
								</div>
							</div>
					...
					<div class="col-sm-4">
						<div class="product-desc">
							<h3>${product.producerName}</h3>
							<p class="price">
								<span>$${product.productPrice}</span> <span class="rate"> <i
							...
							<div class="row">
								<div class="col-sm-12 text-center">
									<p class="addtocart">
										<a href="${pageContext.request.contextPath}/cart/add/${product.productId}" class="btn btn-primary btn-addtocart"><i
										...
										<div class="tab-pane border fade" id="pills-review"
											...
											<div class="row">
												<div class="col-md-8">
													...
													<div class="review">
														<div class="user-img"
															style="background-image: url(${pageContext.request.contextPath}/resources/page/images/person1.jpg)"></div>
														<div class="desc">
															<h4>
													...
													<div class="review">
														<div class="user-img"
															style="background-image: url(${pageContext.request.contextPath}/resources/page/images/person2.jpg)"></div>
														<div class="desc">
															<h4>
																<span class="text-left">Jacob Webb</span> <span
																	class="text-right">14 March 2018</span>
													...
													<div class="review">
														<div class="user-img"
															style="background-image: url(${pageContext.request.contextPath}/resources/page/images/person3.jpg)"></div>
														<div class="desc">
															<h4>
																<span class="text-left">Jacob Webb</span> <span
																	class="text-right">14 March 2018</span>
